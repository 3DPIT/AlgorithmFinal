...
![image-20210927220553800](2021.09.26_17837-새로운게임2.assets/image-20210927220553800.png)

## 실수

- 실수한 부분 제거할때 그위치의 벡터값을 지워야하는데 제대로 안지움
- 혹시나 항상 벡터 지울때 실수하는것은 사이즈가 0인경우 포문을 돌지 못하게해야함 
  - 간혹 이것때문에 에러생김
- 13%에서 계속 틀렸는데 문제는 전체적으로 나왔을때 4개 이상인 경우가 있는데 이것을 체크 안하고 넘어가서 생기는 오류였음
- 다행히 설계상 오류는 없었음
